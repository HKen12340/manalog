...
session_start();
$select_sql = 'select DISTINCT task_id,user_id from answer 
...
$insert_sql = 'insert into answer(task_id,number,user_anwser,user_id) VALUES';
$insert_args = [];
...
while($result = $stmt->fetch(PDO::FETCH_ASSOC)){
  ...
  echo $question_num.".";
  if($flag == "insert"){
    $args = [$_POST['task_id'],$number,$_POST['question'.$number],$_SESSION['id']];
